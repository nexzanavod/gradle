 ...
 * <p>
 * The following command line flags will impact the tests to be run, by order of priority:
 * <ul>
 ...
 *     </ul>
 *     </li>
 *     <li>{@code -PtestAllVersions} will run the tests with all configured versions</li>
 *     <li>{@code -PtestPartialVersions} will run the tests with the first and last configured versions</li>
 *     <li>{@code -Dorg.gradle.integtest.versions=(default|all|partial|1,2,3)} will run the tests according to the configured value (see above).</li>
 * </ul>
 *
 * @param <T>
 */
