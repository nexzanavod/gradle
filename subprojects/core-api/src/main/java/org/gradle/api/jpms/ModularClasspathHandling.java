 ...
 * <p>
 * A classpath is a list of JAR files, classes and resources folders passed to one of the JDK's command like javac, java, or javadoc.
 ...
 * <p>
 * Wherever a classpath (a list of files and folders) is configured in Gradle, it can be accompanied by a classpath handling object
