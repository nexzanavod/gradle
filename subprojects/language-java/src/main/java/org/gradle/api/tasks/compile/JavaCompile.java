...
public class JavaCompile extends AbstractCompile {
    ...
    private final Property<ModularClasspathHandling> modularClasspathHandling = getProject().getObjects().property(
        ModularClasspathHandling.class).convention(new DefaultModularClasspathHandling());
    ...
    private DefaultJavaCompileSpec createSpec() {
        ...
        spec.setCompileClasspath(getJavaModuleDetector().inferClasspath(isModule, modularClasspathHandling.get(), getClasspath()));
        spec.setModulePath(ImmutableList.copyOf(getJavaModuleDetector().inferModulePath(isModule, modularClasspathHandling.get(), getClasspath())));
    ...
    @Incubating
    @Input
    public Property<ModularClasspathHandling> getModularClasspathHandling() {
